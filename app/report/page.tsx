      ...
      <Paper sx={{ p: { xs: 3, md: 5 }, bgcolor: '#171717', borderRadius: 1, border: '1px solid rgba(255,255,255,0.08)' }}>
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          <Section title="ขั้นตอนในการเขียนคำร้อง DMCA">
            ...
            <Box sx={{ pl: 2 }}>
              <Typography paragraph sx={{ mb: 2 }}>
                <strong style={{ color: '#fbbf24' }}>ก) ระบุตัวตน:</Box> แจ้งว่าคุณเป็นเจ้าของลิขสิทธิ์ผลงานหรือสิทธิ์แต่เพียงผู้เดียวที่ถูกละเมิด 
                หรือเป็นผู้ที่ได้รับมอบอำนาจให้กระทำการแทนเจ้าของ พร้อมแนบลายเซ็นจริงหรือลายเซ็นอิเล็กทรอนิกส์
              </Typography>

              <Typography paragraph sx={{ mb: 2 }}>
                <strong style={{ color: '#fbbf24' }}>ข) ระบุผลงาน:</Box> ระบุผลงานที่คุณเชื่อว่าถูกละเมิดลิขสิทธิ์ หากมีหลายผลงาน ให้ระบุเป็นรายการ
              </Typography>

              <Typography paragraph sx={{ mb: 2 }}>
                <strong style={{ color: '#fbbf24' }}>ค) ระบุตำแหน่งของเนื้อหาที่ละเมิดลิขสิทธิ์:</Box> ระบุ URL ของหน้าที่ละเมิดลิขสิทธิ์ในเว็บไซต์ 
                ห้ามส่งไฟล์แนบใดๆ เช่น รูปภาพ หรือไฟล์ PDF ให้ใส่ URL ทั้งหมดในเนื้อหาจดหมาย เพื่อการดำเนินการที่รวดเร็วยิ่งขึ้น
              </Typography>

              <Typography paragraph sx={{ mb: 2 }}>
                <strong style={{ color: '#fbbf24' }}>ง) ข้อมูลติดต่อของคุณ:</Box> ระบุชื่อ ที่อยู่ และอีเมล 
                หากกระทำการแทนเจ้าของลิขสิทธิ์ ให้ระบุความเกี่ยวข้องของคุณ (เช่น ทนายความ, ตัวแทน)
              </Typography>

              <Typography paragraph sx={{ mb: 2 }}>
                <strong style={{ color: '#fbbf24' }}>จ) ยืนยันว่าคุณเชื่อโดยสุจริต:</Box> ระบุว่าคุณเชื่อโดยสุจริตว่าการใช้เนื้อหาดังกล่าวไม่ได้รับอนุญาตจากเจ้าของลิขสิทธิ์ 
                ตัวแทน หรือไม่ชอบด้วยกฎหมาย
              </Typography>

              <Typography paragraph>
                <strong style={{ color: '#fbbf24' }}>ฉ) ยืนยันความถูกต้องของข้อมูล:</Box> ระบุข้อความต่อไปนี้เพื่อรับรองความถูกต้องของข้อมูลภายใต้บทลงโทษของการให้การเท็จ:
              </Typography>
          ...
          <Section title="นโยบายและข้อมูลเพิ่มเติม">
            <Box component="ul">
              <Typography component="li">MAGGA เป็นเว็บไซต์ที่ให้บริการด้านการอ่านและเผยแพร่เนื้อหาที่เกี่ยวข้องกับการ์ตูนแปลไทย</Typography>
