import { Skeleton, Box, Paper, Grid, Container } from "@mui/material";

export default function SubmitEditLoading() {
  return (
    <Container maxWidth="lg" sx={{ py: 4 }}>
      <Grid container spacing={3}>
        {/* Header */}
        <Grid item xs={12} sx={{ mb: 2 }}>
          <Skeleton variant="text" width={200} height={48} sx={{ bgcolor: "rgba(255,255,255,0.05)" }} />
          <Skeleton variant="text" width={250} sx={{ bgcolor: "rgba(255,255,255,0.05)" }} />
        </Grid>

        {/* Left Column */}
        <Grid item xs={12} md={7}>
          <Paper sx={{ p: 3, borderRadius: 1, bgcolor: '#171717' }}>
        ...
        <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'flex-end', gap: 2 }}>
          <Skeleton variant="rectangular" width={80} height={40} sx={{ bgcolor: "rgba(255,255,255,0.05)", borderRadius: 1 }} />
          <Skeleton variant="rectangular" width={120} height={40} sx={{ bgcolor: "rgba(255,255,255,0.05)", borderRadius: 1 }} />
          <Skeleton variant="rectangular" width={150} height={40} sx={{ bgcolor: "rgba(255,255,255,0.05)", borderRadius: 1 }} />
        </Grid>
      </Grid>
    </Container>
  );
