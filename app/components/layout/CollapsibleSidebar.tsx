  ...
  return (
    <Box
      sx={{
        ...
        p: 1.5, // Add padding around the sidebar
      }}
    >
      <Box
        component="aside"
        sx={{
          ...
          height: "calc(100vh - 24px)", // Account for outer padding
          bgcolor: "#171717",
          border: "1px solid rgba(255,255,255,0.08)",
          borderRadius: 1, // Rounded corners
          boxShadow: "0 4px 24px rgba(0,0,0,0.4)", // Floating shadow
          display: "flex",
      ...
      >
        ...
        <Box
          sx={{
            ...
            mb: 1, // Add margin bottom instead of padding for separation
            minHeight: 56,
          }}
        >
          {!isCollapsed && (
