...
- หน้า `/moxzk` และไฟล์ที่เกี่ยวข้องถูกลบจาก checkout แล้ว; เอา machine metadata `rating: mature` และ `adult: true` ที่เคยใช้ทั้งเว็บออก และเอาคำว่า `18+` ออกจากคำอธิบายหลักและท้ายเว็บ แต่คงหน้าต่างยืนยันอายุ
