...
โปรเจกต์นี้ไม่ได้เปิด source code เป็น open-source โดยค่าเริ่มต้น ค่า `license` ใน `package.json` ถูกตั้งเป็น `UNLICENSED` เพื่อป้องกันความเข้าใจผิดว่าอนุญาตให้นำโค้ดไปใช้ซ้ำ แจกต่อ หรือใช้เชิงพาณิชย์ได้อัตโนมัติ

ชื่อ MAGGA, โลโก้, branding, งานออกแบบ, รูปมังงะ, ปก, หน้าอ่าน, งานแปล, metadata, comments, user submissions และเนื้อหาในเว็บไซต์ ไม่ได้อยู่ภายใต้ open-source license ของโค้ดใด ๆ

แพ็กเกจภายนอกที่โปรเจกต์ใช้งานยังคงอยู่ภายใต้ license ของแต่ละแพ็กเกจ ดูรายละเอียดเพิ่มเติมใน [NOTICE.md](./NOTICE.md)
